...
const busTicketPrices: Array<number | string> = [100, 200, 300]; // second way of typing
...
const girlsILikeNames: readonly string[] = ["alina", "kiran", "nimra", "alishba", "sara"];
...
const myMostFavoriteGirlNames: string[] = ["alina", "kiran", "nimra", "alishba", "sara"];
