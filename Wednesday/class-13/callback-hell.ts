...
function checkWeather_1(callback: () => void) {
...
function cookGreenChicken(callback: () => void) {
...
function packBags_2(callback: () => void) {
...
function loadCar_1(callback: () => void) {
...
checkWeather_1(function () {
    cookGreenChicken(function () {
        packBags_2(function () {
            loadCar_1(function () {
